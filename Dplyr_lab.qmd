...
# Can't figure out why it says that "Could not find function pivot_wider", eventhough I have the packages needed
```
...
# Same problem with the pivot functions, in our last class it was working
```
